...
class Play(LMCPObject.LMCPObject):
    ...
    def pack(self):
        ...
        buffer.append(struct.pack(">q", self.PlayID))   # changed from l to q
    ...
    def unpack(self, buffer, _pos):
        ...
        self.PlayID = struct.unpack_from(">q", buffer, _pos)[0] # changed from l to q
        _pos += 8
