...
class SeriesEnum:
    ...
    def getName(self, type):
        ...
        if(type ==  61): return "Play"
        if(type ==  62): return "Command"
        if(type ==  63): return "ShieldInfo"
    ...
    def getType(self, name):
        ...
        if ( name == "Play"): return 61
        if ( name == "Command"): return 62
        if ( name == "ShieldInfo"): return 63
    ...
    def getInstance(self, type):
        ...
        if(type ==  61): return Play.Play()
        if(type ==  62): return Command.Command()
        if(type ==  63): return ShieldInfo.ShieldInfo()
